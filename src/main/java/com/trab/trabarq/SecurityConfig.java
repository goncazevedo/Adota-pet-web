...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/usuario/login").permitAll().antMatchers("/usuario/registration").permitAll().antMatchers("/").permitAll().antMatchers("/stylesheets/**").permitAll().antMatchers("/js/**").permitAll().antMatchers("/img/**").permitAll().antMatchers("/fonts/**").permitAll().anyRequest()
